...
@NgModule({
  declarations: [...COMPONENTS, LoginButtonComponent, SignupButtonComponent, LogoutButtonComponent],
  imports: [CommonModule, RouterModule],
  exports: [...COMPONENTS, LoginButtonComponent, SignupButtonComponent, LogoutButtonComponent],
})
